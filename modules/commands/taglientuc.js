...
if (args.length == 0) return api.sendMessage( `=== [ 𝗧𝗔𝗚 𝗟𝗜𝗘𝗡 𝗧𝗨̣𝗖 ] ===\n━━━━━━━━━━━━━\n→ 𝗖𝗮́𝗰𝗵 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴\n!𝘁𝗮𝗴𝗹𝗶𝗲𝗻𝘁𝘂𝗰 @nguyễn mạnh 5 5\n𝗖𝗼́ 𝗻𝗴𝗵𝗶̃𝗮 𝗹𝗮̀ 5 𝗴𝗶𝗮̂𝘆 𝘀𝗲̃ 𝘁𝗮𝗴 1 𝗹𝗮̂̀𝗻 𝗰𝗵𝗼 đ𝗲̂́𝗻 𝗵𝗲̂́𝘁\n𝗧𝘂̀𝘆 𝘁𝗵𝗲𝗼 𝘀𝗼̂́ 𝗯𝗮̣𝗻 𝗰𝗵𝗼̣𝗻 `, event.threadID, event.messageID);
function delay(ms) {
