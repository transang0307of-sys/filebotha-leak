    ...
    try {
        switch (args[0]) {
            case 'infohero': {
                ...
                const {
                    data
                } = (await get(`https://api.nguyenlienmanh.com/v2/lienquan/chi-tiet-tuong?h=${hero}&l=${level}`)).data;
                api.sendMessage({
            ...
            case 'listhero': api.sendMessage((await get(`https://api.nguyenlienmanh.com/v2/lienquan/find-hero?c=listhero`)).data.message, event.threadID); break;
