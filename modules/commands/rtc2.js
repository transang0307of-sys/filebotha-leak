    ...
    switch (handleReply.type) {
        ...
        case "create": {
            ...
            setTimeout(() => {
                ...
                return request(encodeURI(`https://canvas.nguyenlienmanh.com/api/bannertc2?apikey=DVB&name=${text1}&age=${text2}&text=${text3}`)).pipe(fs.createWriteStream(__dirname + '/cache/fbcover.png')).on('close', () => callback());
            }, 1000);
          }, messageID);
        }
    }}