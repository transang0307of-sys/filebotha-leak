...
module.exports.config = {
	...
	commandCategory: "quản trị viên", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
...
module.exports.run = async ({ api, event, args, Threads }) => {
	...
	if(!args[0]) return api.sendMessage("locmen + số lượng tin nhắn", threadID);
